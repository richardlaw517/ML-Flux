...
%% Sample reversible nonOxPPP constraint fluxes 
rng(122)
tic
%change nonOxPPP lb constraints for reversible nonOxPPP samples
model.lb(13:17)=[-0.4; -0.4; -0.4; -0.4; -0.4]; %nonOxPPP
options.nFiles=1;
options.nPointsPerFile=200000;
[modelSampling,samples] = sampleCbModel(model,'SampledFluxes','ACHR',options);
toc

%% Conduct rejection sampling
load("SampledFluxes.mat") % Generated from above section
%%
