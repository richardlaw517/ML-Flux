...
def create_ANN(input_shape, output_shape):
    ...
    model.add(keras.layers.Dense(246, activation = 'relu', name="Dense_1"))
    model.add(keras.layers.Dense(16, activation = 'relu', name="Dense_2"))
    model.add(keras.layers.Dense(16, activation = 'relu', name="Dense_3"))
    model.add(keras.layers.Dense(16, activation = 'relu', name="Dense_4"))
    model.add(keras.layers.Dense(35, activation = 'relu', name="Dense_5"))
...
ANN_regression = create_ANN(35, 7) #num of columns in single matrix and number of free fluxes
